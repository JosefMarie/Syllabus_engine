...
import { getSyllabusById, getSubtopicProgress, toggleSubtopicProgress } from "@/lib/db";
...
import { BookOpen, ShieldCheck, ArrowLeft, RefreshCw } from "lucide-react";
        ...
        <main className="flex-1 pb-16">
          {activeSubtopic ? (
            <SubtopicView
              ...
              onPrevSubtopic={prevSubtopic ? () => setActiveSubtopic(prevSubtopic) : undefined}
              onNextSubtopic={nextSubtopic ? () => setActiveSubtopic(nextSubtopic) : undefined}
            />
          ) : (
